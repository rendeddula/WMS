...
<td><a href="newSalesOrder">Add</a></td>
</tr>
		...
		<td><a href="<c:url value='/viewOrder?id=${listValue.orderHeaderId}' />">View</a></td>
			...
			<td><a href="<c:url value='/editSalesOrder?id=${listValue.orderHeaderId}' />">Edit</a></td>
			
			<td><a href="<c:url value='/deleteSalesOrder?id=${listValue.orderHeaderId}' />">Delete</a></td>	
